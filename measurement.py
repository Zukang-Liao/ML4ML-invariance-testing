# To generate a json file (stats1515.json) for each model at json_path
...
def argparser():
    ...
    # The directory where the test_actoverall1515.npy and test_results1515.npy files are
    ...
    args.json_path = os.path.join(args.plot_dir, "stats1515.json")
